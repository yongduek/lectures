...
# origin: https://gist.github.com/blole/dfebbec182e6b72ec16b66cc7e331110
...
class Runner:
    ...
    def run(self):
        ...
        # env = Monitor(env, self.dir, force=True)

        print (self.env_name, 'start!')
        ...
        for loop in range(self.loops):
            ...
            for _ in range(self.playouts):
                state = copy(env)  # without monitor wrapper
                # del state._monitor
...
def main():
    ...
    # Toy text
    Runner(rec_dir, 'Taxi-v3',   loops=100, playouts=4000, max_depth=50).run()
