...
Making a video game is a good way of learning a programming language.


# Basic structure of a program with infinite loop

# Background image creation

# Direct drawing on the background image

# Circle drawing for animation

# Many circles 

# Blit operation
    - What is blit? See wikipedia.

# Image file loading

# Animation of a set of still images
...
# Layered updates and parallax scrolling

# Inheritance and physics (17)

# Collision detection (step 18)


# Box2d for 2D pysical engine

# Simple Shooting Game
    - keyborad control (left, right), space key for shoot
    - hit baloons floating on the sky, moving down slowly
    - the game finishes when a baloon sits on the ground.
