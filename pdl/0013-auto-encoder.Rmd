...
```{r simpleAESample0, echo=FALSE, fig.align='center', fig.cap='Sample output after 1 epoch of training (rep_dim=4).'}
knitr::include_graphics('data/samples/image_0.png')
```

```{r simpleAESample1, echo=FALSE, fig.align='center', fig.cap='Sample output after 40 epochs of training'}
...
```{r convAESample0, echo=FALSE, fig.align='center', fig.cap='Sample output after 90 epochs of training (rep_dim=4) by convolutional AE.'}
...
```{r, fig.align='center', fig.cap='Sample output from VAE decoder with $z\sim N(0,1)$'}
