...
```{r, echo=FALSE, fig.align='center', fig.cap='Semantic Segmentation'}
knitr::include_graphics('figures/sem-seg.png')
```
```{r, echo=FALSE, fig.align='center', fig.cap='Instance Segmentation'}
knitr::include_graphics('figures/inst-seg.png')
```
