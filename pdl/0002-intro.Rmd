...
```{r ctcWhy, echo=FALSE, fig.align='center', fig.cap='Connectionist Temporal Classification, why?'}
...
```{r audioSampling, echo=FALSE, fig.align='center', fig.cap='Sampling an audio signal.'}
knitr::include_graphics('figures/audio-sampling-steps.gif')
```
