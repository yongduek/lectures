...
- A Review on [Attention-based Extraction of Structured Information from Street View Imagery](https://norman3.github.io/papers/docs/attention_ocr.html)
- FSNS dataset
...
knitr::include_graphics('figures/attention-ocr/f01.png')
```
...
```{r , echo=FALSE, fig.align='center'}
knitr::include_graphics('figures/attention-ocr/f02.png')
```
...
```{r , echo=FALSE, fig.align='center'}
knitr::include_graphics('figures/attention-ocr/f03.png')
```
...
```{r , echo=FALSE, fig.align='center'}
knitr::include_graphics('figures/attention-ocr/f04.png')
```
...
```{r , echo=FALSE, fig.align='center'}
knitr::include_graphics('figures/attention-ocr/f05.png')
```
```{r , echo=FALSE, fig.align='center'}
knitr::include_graphics('figures/attention-ocr/f06.png')
```
```{r , echo=FALSE, fig.align='center'}
knitr::include_graphics('figures/attention-ocr/f07.png')
```
```{r , echo=FALSE, fig.align='center'}
knitr::include_graphics('figures/attention-ocr/f08.png')
```
...
```{r , echo=FALSE, fig.align='center'}
knitr::include_graphics('figures/attention-ocr/f09.png')
```
