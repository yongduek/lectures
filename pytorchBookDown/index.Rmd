--- 
title: "A Practical Guide to Deep Learning with Pytorch"
...
link-citations: yes
description: "Pytorch practice and deep learning."
---
...
import sys
x = 'Hello python'
print (x.split(' '), '파이선 버전=', sys.version)
```

Pandas  패키지 사용하는 것도 간단하다.
``` {python}
import pandas as pd
df = pd.read_csv ('../bayesian/showcases.2012.csv')
print (df.head())
```
